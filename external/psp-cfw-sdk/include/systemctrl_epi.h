...
enum AdrenalineVitaCommands {
	...
	ADRENALINE_VITA_CMD_OPEN_TROPHIES, /* Adrenaline+ RetroAchievements trophy screen; value 16; append-only, must match adrenaline_vita.h */
};
...
typedef struct {
    ...
    char iso_path[256];   /* sctrlSEGetUmdFile() at boot; "" for non-ISO launches.
                             Append-only; must stay byte-identical to adrenaline_vita.h */
